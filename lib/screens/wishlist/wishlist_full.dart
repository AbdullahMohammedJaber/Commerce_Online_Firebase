...
import 'package:kdr_store/models/favs_attr.dart';
import 'package:kdr_store/models/product.dart';
import 'package:kdr_store/provider/favs_provider.dart';
    ...
    return Stack(
      children: <Widget>[
        Container(
          ...
          margin: EdgeInsets.only(right: 30.0, bottom: 10.0, top: 10),
          child: Material(
